...
var normalizeResponse = function (decoded) {
  var response = [
    {
      field: "RESPONSE_FPORT",
      value: decoded.fPort,
    },
    {
      field: "RESPONSE_STATUS",
      value: decoded.status,
    },
    {
      field: "RESPONSE_TYPE",
      value: decoded.type,
...
var normalizeSettingsReport = function (data) {
  return [
    {
      field: "LORAWAN_REPORT_INTERVAL",
      value: data.lorawanReportInterval,
    },
  ];
};
...
var normalizeStatusReport = function (decoded) {
  return [
    {
      field: "TOTAL_VOLUME",
      value: decoded.totalVolume,
    },
    {
      field: "LEAK_IS_ONGOING",
      value: decoded.leakState > 2,
    },
    {
      field: "LEAK_STATE",
      value: decoded.leakState,
    },
    {
      field: "LEAK_STATUS",
      value: leakStates[decoded.leakState]
        ? leakStates[decoded.leakState]
        : "noLeak",
    },
    {
      field: "WATER_TEMPERATURE_MIN",
      value: decoded.waterTemperatureMin,
    },
    {
      field: "WATER_TEMPERATURE_MAX",
      value: decoded.waterTemperatureMax,
    },
    {
      field: "AMBIENT_TEMPERATURE",
      value: decoded.ambientTemperature,
    },
    {
      field: "IS_SENSING",
      value: decoded.isSensing,
    },
    {
      field: "BATTERY_VOLTAGE",
      value: decoded.batteryRecovered / 1000,
    },
    {
      field: "BATTERY_STATUS",
      value: isLowBattery(decoded.batteryRecovered) ? "LOW" : "OK",
    },
  ];
};
...
function Decoder(payload, port) {
  ...
  var topics = normalizeUplink(decoded);
